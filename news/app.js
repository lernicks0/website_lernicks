(() => {
  ...
  function edit() {
    ...
    form.onsubmit = async event => {
      ...
      try {
        ...
        notice('投稿成功，已送达王韩润的审核箱。'); location.hash = '#mine';
  ...
  async function submissions(review, version) {
    if (!me.account) return loginGate();
    if (review && !me.canReview) { $('#view').innerHTML='<div class="empty"><h1>审核箱仅对王韩润开放</h1><a href="#home">返回新闻首页</a></div>'; return; }
